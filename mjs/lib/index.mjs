...
export default class Pagination {
  static BULLET_CHAR = '•'
  static LEFT_ARROW_CHAR = '‹'
  static RIGHT_ARROW_CHAR = '›'
  static LEFT_DOUBLE_ARROW_CHAR = '«'
  static RIGHT_DOUBLE_ARROW_CHAR = '»'
  static ELLIPSIS_CHAR = '…'
  static mode = Mode.STANDART
  static pageCount = 0
  static pageNumber = 1
  static pageStep = 1
  static maxPageButtons = 10
  static hasFirstPage = false
  static hasPreviousPage = false
  static hasNextPage = false
  static hasLastPage = false
  static pageSteps = [1, 5, 10, 25, 100]
  static firstPageButtonDisplay = Display.AUTO
  static previousPageButtonDisplay = Display.AUTO
  static currentPageButtonDisplay = Display.AUTO
  static nextPageButtonDisplay = Display.AUTO
  static lastPageButtonDisplay = Display.AUTO
  static previousPageNumberButtonsDisplay = Display.AUTO
  static nextPageNumberButtonsDisplay = Display.AUTO
  static pageStepButtonsDisplay = Display.AUTO
  static showFirstPageNumber = true
  static showPreviousPageNumber = true
  static showCurrentPageNumber = true
  static showNextPageNumber = true
  static showLastPageNumber = true
  static showAllPageStepButtons = false
  static types = types
  ...
  static pageNumbersWindow(options = {}) {
